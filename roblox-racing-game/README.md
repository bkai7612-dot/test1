...
| **Race types** | Vote on **Circuit** (laps), **Sprint** (one flat-out lap) or **Elimination** (last place is knocked out every lap until one is left; needs 3+ racers) along with the map. |
...
| **Cosmetic items** | Bought once with coins, then equipped on any car from CUSTOMIZE (first click previews, second click buys). **Wings:** Angel, Bat, Butterfly, Dragon, Jet. **Eyes:** Cute, Angry, Lashes, Love, Robot visor. **Trails:** Blue Streak, Fire, Ice, Toxic, Gold, Rainbow. Trails are a flat ribbon just above the road, so they never block the car behind. |

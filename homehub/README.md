...
HomeHub is a free, responsive web app for homeowners and renters to keep track of their properties, rooms, appliances,
...
- Email: `demo@homehub.test`
- Password: `homehub-demo`
...
- **Private storage.** Files live in the private `homehub` bucket under `<user_id>/<property_id>/<area>/…`. Storage
